...
@section('title', 'ตรวจเอกสาร')

@section('topbar-title')
  <span class="tt-kicker" data-i18n="recruit.kicker">การสรรหา</span>
  <span class="tt-title" data-i18n="nav.rcReview">ตรวจเอกสาร</span>
@endsection
...
@section('content')
  <div class="rc-stub">
    <svg class="rc-stub-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><path d="M14 2v6h6"></path><path d="m9 15 2 2 4-4"></path></svg>
    <h1 data-i18n="nav.rcReview">ตรวจเอกสาร</h1>
